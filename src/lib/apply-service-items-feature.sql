-- ============================================================
-- Service & Non-Inventory Items Feature Implementation
-- ============================================================
...
DECLARE
    ...
    year_prefix TEXT;
    seq_count INTEGER;
    layer_id_text TEXT; -- Fixed: Added declaration
BEGIN
    ...
    LOOP
        ...
        INTO 
            ...
            v_cogs_account_id
        FROM inventory_items -- Or inventory_items if that is the main table
    ...
    LOOP
        ...
        IF v_item_type = 'service' THEN
            ...
            IF v_expense_account_id IS NULL THEN
                 ...
                 SELECT id INTO v_target_account_id FROM accounts WHERE account_code LIKE '5%' LIMIT 1; 
                 -- Ideally, specific code. Let's use 510001 (COGS) as fallback or better a General Expense.
                 -- Let's use 5299 'General Expenses' or similar if exists. 
                 -- Safest is to fallback to 510001 for now or 5200.
