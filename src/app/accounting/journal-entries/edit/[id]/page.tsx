...
import { updateJournalEntry, getJournalEntryDetails } from '@/lib/journal-actions';
...
export default function EditJournalEntryPage() {
    ...
    useEffect(() => {
        ...
        getJournalEntryDetails(entryId).then(entry => {
            if (!entry) {
            ...
            if (entry.reference_type !== 'manual') {
                toast({ title: 'تنبيه', description: 'لا يمكن تعديل القيود المُنشأة تلقائياً', variant: 'destructive' });
                router.back();
                return;
            }
        ...
        <div className="space-y-6 max-w-6xl mx-auto pb-20">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-slate-500">تعديل القيد اليومي اليدوي</p>
                </div>
            </div>
